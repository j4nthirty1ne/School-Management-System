  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userType === "student") {
        ...
        requestBody.studentCode = `STU-${Date.now()}-${Math.floor(
          Math.random() * 1000
        )}`;
        ...
        // Teacher code is auto-generated by backend
        requestBody.hireDate = formData.hireDate;
        requestBody.subjectSpecialization =
          formData.subjectSpecialization || undefined;
            ...
            <div className="space-y-4 border-t pt-4">
              ...
              {/* <div className="space-y-2 bg-blue-50 dark:bg-blue-950 p-4 rounded-md">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300">
                  System will automatically generate a unique teacher code
                  (e.g., TCH-2025-001)
                </p>
              </div> */}
