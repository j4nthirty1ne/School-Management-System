...
export function TeacherDashboard() {
  const classes = [
    { id: "C001", name: "Mathematics 10-A", students: 28, time: "Mon, Wed, Fri 9:00 AM" },
    { id: "C002", name: "Mathematics 10-B", students: 32, time: "Tue, Thu 10:00 AM" },
    { id: "C003", name: "Advanced Math 11-A", students: 24, time: "Mon, Wed 2:00 PM" },
  ]
            ...
            {classes.map((cls) => (
              <div key={cls.id} className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{cls.students} students • {cls.time}</p>
                </div>
                <div className="flex gap-2">
                  <Button variant="outline" size="sm">Mark Attendance</Button>
                  <Button variant="outline" size="sm">Upload Grades</Button>
                </div>
              </div>
            ))}
          </div>
